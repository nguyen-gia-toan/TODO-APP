...
- **Database**: MySQL.
- **Thư viện**: `mysql2`, `cors`.

## 🚀 Hướng dẫn cài đặt & Chạy

**Bước 1:** Tải source code (Level muốn tải) về máy.

**Bước 2:** Mở Terminal tại thư mục dự án, chạy lệnh dưới để khởi động server:
```bash
node server.js
```
(Khi thấy dòng thông báo "Server đang chạy tại: http://localhost:3000" là thành công)

**Bước 3: Mở giao diện (Frontend): Click đúp chuột vào file index.html để bắt đầu sử dụng.**
